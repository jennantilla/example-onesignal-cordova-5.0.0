...
function OneSignalInit() {
    ...
    window.plugins.OneSignal.init("b098f904-b0ee-4bc2-8e30-0de3ee24023c");
...
document.getElementById("pauseIAM").addEventListener("click", pauseInAppMessages);
function pauseInAppMessages() {
    window.plugins.OneSignal.InAppMessages.setPaused(true);
}

document.getElementById("resumeIAM").addEventListener("click", resumeInAppMessages);
